...
RSpec.describe JobCastsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested job_cast as @job_cast" do
      job_cast = JobCast.create! valid_attributes
      get :show, {:id => job_cast.to_param}, valid_session
      expect(assigns(:job_cast)).to eq(job_cast)
    end
  end

  describe "GET #new" do
    it "assigns a new job_cast as @job_cast" do
  ...
  describe "GET #edit" do
    it "assigns the requested job_cast as @job_cast" do
      job_cast = JobCast.create! valid_attributes
      get :edit, {:id => job_cast.to_param}, valid_session
      expect(assigns(:job_cast)).to eq(job_cast)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new JobCast" do
        expect {
          post :create, {:job_cast => valid_attributes}, valid_session
        }.to change(JobCast, :count).by(1)
      end

      it "assigns a newly created job_cast as @job_cast" do
        post :create, {:job_cast => valid_attributes}, valid_session
        expect(assigns(:job_cast)).to be_a(JobCast)
        expect(assigns(:job_cast)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved job_cast as @job_cast" do
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      it "assigns the job_cast as @job_cast" do
        job_cast = JobCast.create! valid_attributes
  ...
  describe "DELETE #destroy" do
    it "destroys the requested job_cast" do
      job_cast = JobCast.create! valid_attributes
      expect {
